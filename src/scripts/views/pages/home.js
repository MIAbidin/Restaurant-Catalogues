  ...
  async render () {
    return `
      <section class="app-main__hero" >
        <picture>
          <source media="(max-width: 600px)" type="image/jpeg" data-srcset="./images/hero-image_2-small.webp" >
          <source media="(max-width: 600px)" type="image/jpeg" data-srcset="./images/hero-image_2-small.jpg" >
          <source type="image/webp" data-srcset="./images/hero-image_2.webp">
          <img data-src='./images/hero-image_2.jpg' class="lazyload" alt="Culinary Adventure Background">
        </picture>
